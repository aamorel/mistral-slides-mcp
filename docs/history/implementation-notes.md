...
Archived from the README during repository cleanup on 2026-09-09. This preserves
feature rationale, experiments, and earlier validation notes. Commands, module
paths, and deployment status below reflect their original context and may be
obsolete. Use the [current README](../../README.md), [capabilities](../capabilities.md),
and [auth reference](../auth.md) for the maintained application.
...
Following the working-MVP focus in [scope.md](../assignment.md), tools represent distinct
