...
<p><strong>{name}</strong> is requesting permission to create and read presentations, revise supported text, add content slides, and apply your default colors and font in your Google Drive through MCP Slides.</p>
